...
PADDLE_SPEED = 3  # Aluse liikumise kiirus.
...
while True:
    ...
    # Pall jääb alla serva (negatiivsed punktid).
    if ball_rect.bottom >= HEIGHT:
        score -= 1
        BALL_SPEED_X, BALL_SPEED_Y = -5, -5
        ball_rect.x = WIDTH // 2 - ball_rect.width // 2
        ball_rect.y = HEIGHT // 2 - ball_rect.height // 2
        # Lahutatakse punkt skoorist ja resetitakse palli asukoht.
    ...
    # Aluse liikumise loogika (põrkub seintega).
